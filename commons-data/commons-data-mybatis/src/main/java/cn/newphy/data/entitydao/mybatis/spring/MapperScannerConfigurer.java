...
public class MapperScannerConfigurer
	...
	private static final String ENTITY_DAO_FACTORY_BEAN_NAME = "entityDaoFactory";
	private static final String ENTITY_DAO_ANNOTATION_PROCESSER = "entityDaoAnnotationProcesser";
	private static final String E_CONFIGURATION = "eConfiguration";
	...
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
		...
		registry.registerBeanDefinition(E_CONFIGURATION, configurationDefinition);		

		// register EntityDaoFactory
		GenericBeanDefinition factoryDefinition = new GenericBeanDefinition();
		factoryDefinition.setBeanClass(MybatisEntityDaoFactory.class);
		factoryDefinition.getPropertyValues().add("sqlSessionFactory",
				StringUtils.hasText(this.sqlSessionFactoryBeanName)
						? new RuntimeBeanReference(this.sqlSessionFactoryBeanName) : this.sqlSessionFactory);
		factoryDefinition.getPropertyValues().add("configuration", new RuntimeBeanReference(E_CONFIGURATION));
		registry.registerBeanDefinition(ENTITY_DAO_FACTORY_BEAN_NAME, factoryDefinition);
		
		// register entityDaoAnnotationProcesser 
		GenericBeanDefinition annotationProcessDefinition = new GenericBeanDefinition();
		annotationProcessDefinition.setBeanClass(EntityDaoAnnotationProcessor.class);
		annotationProcessDefinition.getPropertyValues().add("entityDaoFactory", new RuntimeBeanReference(ENTITY_DAO_FACTORY_BEAN_NAME));
		registry.registerBeanDefinition(ENTITY_DAO_ANNOTATION_PROCESSER, annotationProcessDefinition);		
		
		ClassPathEntityDaoScanner scanner = new ClassPathEntityDaoScanner(registry);
		...
		scanner.setEntityDaoFactoryBeanName(ENTITY_DAO_FACTORY_BEAN_NAME);
